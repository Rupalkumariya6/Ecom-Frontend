            ...
            <section className="text-gray-600 body-font">
                <div className=" container px-5 py-8 mx-auto ">
                    <div className="mx-auto flex flex-wrap space-x-4">
                        <img alt="ecommerce" className="lg:w-[32%] w-full lg:h-auto h-64 object-cover object-center rounded" src="https://www.bonkerscorner.com/cdn/shop/files/flower-girl-hello-kitty-oversized-t-shirt-xs-bonkerscorner-store-33708665503844_375x_crop_center.jpg?v=1728978928" />
                        <img alt="ecommerce" className="lg:w-[32%] w-full lg:h-auto h-64 object-cover object-center rounded" src="https://www.bonkerscorner.com/cdn/shop/files/flower-girl-hello-kitty-oversized-t-shirt-xs-bonkerscorner-store-33708665634916_375x_crop_center.jpg?v=1728978971" />
                        <img alt="ecommerce" className="lg:w-[32%] w-full lg:h-auto h-64 object-cover object-center rounded" src="https://www.bonkerscorner.com/cdn/shop/files/flower-girl-hello-kitty-oversized-t-shirt-xs-bonkerscorner-store-33708665602148_375x_crop_center.jpg?v=1728978937" />
