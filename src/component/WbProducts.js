            ...
            <section className="text-gray-600 body-font">
                <div className=" container px-5 py-8 mx-auto ">
                    <div className="mx-auto flex flex-wrap space-x-4">
                        <img alt="ecommerce" className="lg:w-[32%] w-full lg:h-auto h-64 object-cover object-center rounded" src="https://www.bonkerscorner.com/cdn/shop/files/kuromi-villen-baby-tee-xs-bonkerscorner-store-33708619006052_375x_crop_center.jpg?v=1728978864" />
                        <img alt="ecommerce" className="lg:w-[32%] w-full lg:h-auto h-64 object-cover object-center rounded" src="https://www.bonkerscorner.com/cdn/shop/files/kuromi-villen-baby-tee-xs-bonkerscorner-store-33708618842212_375x_crop_center.jpg?v=1728983409" />
                        <img alt="ecommerce" className="lg:w-[32%] w-full lg:h-auto h-64 object-cover object-center rounded" src="https://www.bonkerscorner.com/cdn/shop/files/kuromi-villen-baby-tee-xs-bonkerscorner-store-33708619071588_375x_crop_center.jpg?v=1728983364" />
