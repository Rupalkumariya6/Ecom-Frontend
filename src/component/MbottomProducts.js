            ...
            <section className="text-gray-600 body-font">
                <div className=" container px-5 py-8 mx-auto ">
                    <div className="mx-auto flex flex-wrap space-x-4">
                        <img alt="ecommerce" className="lg:w-[32%] w-full lg:h-auto h-64 object-cover object-center rounded" src="https://www.bonkerscorner.com/cdn/shop/files/beige-cargo-with-utility-pockets-xs-bonkerscorner-store-33693701374052_375x_crop_center.jpg?v=1728978935" />
                        <img alt="ecommerce" className="lg:w-[32%] w-full lg:h-auto h-64 object-cover object-center rounded" src="https://www.bonkerscorner.com/cdn/shop/files/beige-cargo-with-utility-pockets-xs-bonkerscorner-store-33693703536740_375x_crop_center.jpg?v=1728982227" />
                        <img alt="ecommerce" className="lg:w-[32%] w-full lg:h-auto h-64 object-cover object-center rounded" src="https://www.bonkerscorner.com/cdn/shop/files/beige-cargo-with-utility-pockets-xs-bonkerscorner-store-33693701341284_375x_crop_center.jpg?v=1728982501" />
...
export default MbottomProducts